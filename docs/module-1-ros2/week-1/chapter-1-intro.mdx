...
```mermaid
graph TB
    A[Your Robot Application<br/>Python/C++ Nodes] --> B[RCL<br/>ROS Client Library]
    B --> C[DDS Middleware<br/>Fast DDS, Cyclone DDS]
    C --> D[Operating System<br/>Linux, Windows, macOS]
    D --> E[Hardware<br/>Sensors, Actuators]
...
```mermaid
graph LR
    A[Module 1<br/>ROS 2 Fundamentals] --> B[Module 2<br/>Digital Twin Simulation]
    B --> C[Module 3<br/>NVIDIA Isaac]
    C --> D[Module 4<br/>VLA Robotics]
    D --> E[Module 5<br/>Capstone Project]
...
[Continue to Chapter 2: Installing ROS 2 →](/module-1-ros2/week-1/chapter-2-setup)
...
**Progress**: Module 1, Week 1, Chapter 1 of 32 | [View all chapters](/intro)
